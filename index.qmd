...
2.  ¿Cuántos de los equipos en el top 20 de los que han jugado mas juegos, han jugado en casa y han jugado la liga NL? ¿Cuántos la liga AL? ¿Cuáles?
    ...
    Para esta pregunta se realizó una función que encontrara el top x de equipos dada una variable. Además, se utilizó **programación defensiva**, uno de los temas vistos en el curso, para asegurar que la función corra adecuadamente y si no que retorne un mensaje indicando el error.
